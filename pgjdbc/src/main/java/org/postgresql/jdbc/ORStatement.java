...
public class ORStatement implements Statement {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        ...
        if (sql == null || sql.isEmpty()) {
            throw new PSQLException("sql is invalid", PSQLState.INVALID_PARAMETER_VALUE);
        }
        ORCachedQuery cachedQuery = new ORCachedQuery(connection, this, sql, false);
        execute(cachedQuery, null);
        if (rs == null) {
            throw new PSQLException(exception, PSQLState.NO_DATA);
        }
        return rs;
    }
    ...
    public void setFetchSize(int rows) throws SQLException {
        verifyClosed();
        if (rows < 0) {
            throw new PSQLException("Fetch size must be a value greater to or equal to 0.",
    ...
    public ResultSet getGeneratedKeys() throws SQLException {
        ...
        synchronized (this) {
            ...
            throw new PSQLException("No generated keys results were returned", PSQLState.NO_DATA);
        }
    }
    ...
    public int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
        ...
        throw new PSQLException("Returning autogenerated keys by column "
    ...
    public boolean execute(String sql, int[] columnIndexes) throws SQLException {
        ...
        throw new PSQLException("Returning autogenerated keys by column index is not supported.",
