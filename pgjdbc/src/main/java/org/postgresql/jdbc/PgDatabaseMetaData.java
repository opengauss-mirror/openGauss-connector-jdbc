...
public class PgDatabaseMetaData implements DatabaseMetaData {
  ...
  static {
    ...
    ht.put("SCHEMAS",
        "c.relkind = 'v' AND (n.nspname = 'pg_catalog' OR n.nspname = 'information_schema' OR n.nspname = 'sys') ");
    ht.put("NOSCHEMAS", "c.relkind = 'v' AND c.relname ~ '^pg_'");
    ht = new HashMap<String, String>();
    ...
    ht.put("SCHEMAS", "c.relkind = 'r' AND (n.nspname ~ '^pg_temp_' OR c.relpersistence = 'g') ");
    ht.put("NOSCHEMAS", "c.relkind = 'r' AND (c.relname ~ '^pg_temp_' OR c.relpersistence = 'g') ");
    ht = new HashMap<String, String>();
    tableTypeClauses.put("LOCAL TEMPORARY", ht);
  ...
  public boolean isWrapperFor(Class<?> iface) throws SQLException {
      throw org.postgresql.Driver.notImplemented(this.getClass(), "isWrapperFor(Class<T>)");
